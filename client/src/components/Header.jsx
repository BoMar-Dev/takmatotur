...
const Header = () => {
  ...
  return (
    <header style={{ 
      ...
      className=" px-8 lg:px-[100px] z-30 flex w-full h-[400px] md:h-[400px] lg:h-[450px] xl:h-[500px] 2xl:h-[600px] 3xl:h-[1000px]"
    >
      <div className="flex flex-col lg:flex-row w-full justify-between items-start">
        ...
        <nav className="hidden lg:flex space-x-12 pt-12">
          <Link to={"/takmatotur"} className="text-PrimaryColor hover:text-slate-500 transition font-semibold">
            Tak Mat O Tur
          </Link>
          <Link to={"/trailcamp"} className="text-PrimaryColor hover:text-slate-500 transition font-semibold">
            Trail Camp
          </Link>
          <Link to={"/coach"} className="text-PrimaryColor hover:text-slate-500 transition font-semibold">
            Löpcoach
          </Link>
          <Link to={"/topptur"} className="text-PrimaryColor hover:text-slate-500 transition font-semibold">
            Topptur
          </Link>
          <Link to={"/boende"} className="text-PrimaryColor hover:text-slate-500 transition font-semibold">
            Boende
          </Link>
          <Link to={"/kontakt"} className="text-PrimaryColor hover:text-slate-500 transition font-semibold">
            Kontakt
          </Link>
        </nav>
      </div>
